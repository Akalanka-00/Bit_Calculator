...
class ByteBitScreen extends StatefulWidget {
  @override
  _ByteBitScreenState createState() => _ByteBitScreenState();
}

class _ByteBitScreenState extends State<ByteBitScreen> {
