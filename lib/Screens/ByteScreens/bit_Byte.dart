...
class BitByteScreen extends StatefulWidget {
  @override
  _BitByteScreenState createState() => _BitByteScreenState();
}

class _BitByteScreenState extends State<BitByteScreen> {
  TextEditingController _bitController = TextEditingController();
  List<ByteList> bytelist = ByteList.byteList;
  List<ByteList> bitlist = ByteList.bitList;
  double inputid = 2;
  double outputid = 2;
  int inputId = 2;
  int outputId = 2;
