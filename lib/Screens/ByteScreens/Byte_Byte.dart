...
class ByteByteScreen extends StatefulWidget {
  @override
  _ByteByteScreenState createState() => _ByteByteScreenState();
}

class _ByteByteScreenState extends State<ByteByteScreen> {
